...
import {OTPRequestFormSchema, OTPRequestFormValues,} from "@/modules/guest/config/schemas/otp.request.form";
...
export default function useVendorRegistration(
    ...
    const handleOTPVerificationSubmit = (
    ...
    const handleSetBusinessAndEmailSubmit = (data: BusinessAndEmailFormValues) => actionSetBusinessAndEmail(data)
        .then(() => {
            toggleSession()
        })
