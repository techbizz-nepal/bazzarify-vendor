...
export const whySellOnPlatform: TWhySellOnPlatform[] = [
  {
    ...
    icon: <GrGraphQl className="size-16 md:size-64 text-primary" />,
  },
  {
    id: "02-free-sign-up",
    title: "Free Signup",
    ...
    icon: <FaHandHoldingHeart className="size-16 md:size-64 text-primary" />,
  },
  {
    ...
    icon: <TbTruckDelivery className="size-16 md:size-64 text-primary" />,
  },
  {
    ...
    icon: <GiPayMoney className="size-16 md:size-64 text-primary" />,
  },
  {
    ...
    icon: <IoMdMegaphone className="size-16 md:size-64 text-primary" />,
  },
  {
    ...
    icon: <GiSkills className="size-16 md:size-64 text-primary" />,
  },
];
