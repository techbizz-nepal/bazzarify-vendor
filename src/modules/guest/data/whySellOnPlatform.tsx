...
export const whySellOnPlatform: TWhySellOnPlatform[] = [
  {
    ...
    icon: <GrGraphQl className="text-primary size-16 md:size-44" />,
  },
  {
    id: "02-free-sign-up",
    title: "Free Signup",
    ...
    icon: <FaHandHoldingHeart className="text-primary size-16 md:size-44" />,
  },
  {
    ...
    icon: <TbTruckDelivery className="text-primary size-16 md:size-44" />,
  },
  {
    ...
    icon: <GiPayMoney className="text-primary size-16 md:size-44" />,
  },
  {
    ...
    icon: <IoMdMegaphone className="text-primary size-16 md:size-44" />,
  },
  {
    ...
    icon: <GiSkills className="text-primary size-16 md:size-44" />,
  },
];
